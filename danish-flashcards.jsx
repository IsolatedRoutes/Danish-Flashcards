...
const TYPE_COLOR = { word: "#4C6B65", sentence: "#A1432E", grammar: "#7A5C8E" };
...
const STARTER_WORDS = {
  "Basic Verbs": [
    ...
    ["samle","to gather / collect"],["sætte","to put / place"],["lægge","to lay down"],
  ],
  "Common Nouns": [
    ...
    ["en sommer","a summer"],["en vinter","a winter"],["et forår","a spring"],["et efterår","an autumn"],["et vejr","weather"],
    ["en sol","a sun"],["en måne","a moon"],["en stjerne","a star"],["en himmel","a sky"],["en sky","a cloud"],
    ["en regn","rain"],["en sne","snow"],["en vind","wind"],["en luft","air"],["et vand","water"],
    ["en ild","fire"],["en jord","earth / soil"],["en sten","a stone"],["et træ","a tree / wood"],["en blomst","a flower"],
    ["et græs","grass"],["et dyr","an animal"],["en hund","a dog"],["en kat","a cat"],["en fugl","a bird"],
    ...
    ["et folk","a people"],["et samfund","a society"],["en regering","a government"],["en politik","politics"],["en lov","a law"],
    ...
    ["en gæst","a guest"],["en nabo","a neighbor"],["en fremmed","a stranger"],["et arbejde","a job / work"],
  ],
  "Adjectives": [
  ...
  "Family & People": [
    ...
    ["en leder","a leader"],["en medarbejder","an employee"],["en pensionist","a retiree"],
  ],
  "Food & Drink": [
    ["en mad","food"],["en morgenmad","breakfast"],["en frokost","lunch"],["en aftensmad","dinner"],["et måltid","a meal"],
    ["et brød","bread"],["et rugbrød","rye bread"],["et smør","butter"],["en ost","cheese"],["en mælk","milk"],
    ["en fløde","cream"],["et æg","an egg"],["et kød","meat"],["et oksekød","beef"],["et svinekød","pork"],
    ["en kylling","chicken"],["en pølse","a sausage"],["en laks","salmon"],["en reje","a shrimp"],["en ris","rice"],
    ["en pasta","pasta"],["en kartoffel","a potato"],["en grøntsag","a vegetable"],["en gulerod","a carrot"],["et løg","an onion"],
    ...
    ["en sovs","a sauce / gravy"],["et krydderi","a spice"],["en peber","pepper"],["et sukker","sugar"],["en honning","honey"],
    ["et syltetøj","jam"],["en kage","a cake"],["en is","ice cream"],["en chokolade","chocolate"],["et slik","candy"],
    ...
    ["en yoghurt","yogurt"],["en spegepølse","salami"],["et smørrebrød","an open sandwich"],
  ],
  "Home & Daily Life": [
    ...
    ["en sæbe","soap"],["en shampoo","shampoo"],["en tandbørste","a toothbrush"],["en tandpasta","toothpaste"],["et toilet","a toilet"],
    ...
    ["en støvsuger","a vacuum cleaner"],["et affald","trash"],["en skraldespand","a trash can"],["en kost","a broom"],["en moppe","a mop"],
    ...
    ["en husleje","rent"],["en forsikring","insurance"],["et abonnement","a subscription"],["et internet","internet"],["en wifi","wifi"],
    ["en husholdning","a household"],["et gøremål","a chore"],["et indkøb","shopping (an errand)"],["en indkøbsliste","a shopping list"],["feje","to sweep"],
    ["stryge","to iron"],["et tøj","clothes"],["en lyspære","a lightbulb"],["en alarm","an alarm"],["et vækkeur","an alarm clock"],
    ...
    ["en rygsæk","a backpack"],["en paraply","an umbrella"],
  ],
  "Travel & Transport": [
    ["en rejse","a trip / journey"],["et pas","a passport"],["et visum","a visa"],["en billet","a ticket"],["en bagage","luggage"],
    ...
    ["en destination","a destination"],["en grænse","a border"],["en told","customs"],["et vandrehjem","a hostel"],["en campingplads","a campsite"],
    ["et telt","a tent"],["en sovepose","a sleeping bag"],["et bagagerum","a trunk"],["et sæde","a seat"],["en sikkerhedssele","a seatbelt"],
    ["en tank","a tank"],["en benzin","petrol"],["en diesel","diesel"],["en tankstation","a gas station"],["en parkering","parking"],
    ["en p-plads","a parking spot"],["en trafik","traffic"],["et trafiklys","a traffic light"],["et fortov","a sidewalk"],["en fodgænger","a pedestrian"],
    ...
    ["en hjemrejse","a return trip"],["et jetlag","jet lag"],["en souvenir","a souvenir"],["en landsby","a village"],["en hovedstad","a capital city"],
    ["en region","a region"],["en kyst","a coast"],["en ø","an island"],["en halvø","a peninsula"],["en fjord","a fjord"],
    ["en dal","a valley"],["en slette","a plain"],
  ],
  "Weather & Nature": [
    ["blæst","windy"],["en storm","a storm"],["et tordenvejr","a thunderstorm"],["et lyn","lightning"],["en torden","thunder"],
    ["en tåge","fog"],["en frost","frost"],["en is (frozen water)","ice"],["en varme","heat"],["en kulde","cold (noun)"],
    ...
    ["en å","a stream"],["en bølge","a wave"],["et sand","sand"],["et insekt","an insect"],["en bi","a bee"],
    ...
    ["en rotte","a rat"],
    ["en dug","dew"],["en hagl","hail"],["et snefnug","a snowflake"],["en solnedgang","a sunset"],["en solopgang","a sunrise"],
    ["en skygge","a shadow"],["en ørken","a desert"],["en vulkan","a volcano"],["en gletsjer","a glacier"],["et jordskælv","an earthquake"],
  ],
  "Body & Health": [
    ...
    ["en hud","skin"],["en muskel","a muscle"],["en knogle","a bone"],["et blod","blood"],["en hjerne","a brain"],
    ...
    ["en behandling","a treatment"],["et helbred","health"],["sund","healthy"],["usund","unhealthy"],["en motion","exercise"],
    ["en træning","training / exercise"],["en diæt","a diet"],["en søvn","sleep"],["en træthed","tiredness"],["en stress","stress"],
    ["en angst","anxiety"],["en graviditet","a pregnancy"],["en fødsel","a birth"],["en vaccine","a vaccine"],["et plaster","a band-aid"],
    ["en bandage","a bandage"],["en krykke","a crutch"],["en kørestol","a wheelchair"],["briller","glasses"],["en kontaktlinse","a contact lens"],
    ["et høreapparat","a hearing aid"],
  ],
  "Work & School": [
    ...
    ["lektier","homework"],["et skema","a schedule"],["et fag","a subject"],["en matematik","math"],["et dansk","Danish (subject)"],
    ["et engelsk","English (subject)"],["en geografi","geography"],["en fysik","physics"],["en kemi","chemistry"],["en biologi","biology"],
    ["en idræt","PE / sports"],["en musik","music"],["en kunst","art"],["en pause","a break"],["et frikvarter","recess"],
    ...
    ["en afgangseksamen","a final exam"],["et diplom","a diploma"],["en grad","a degree"],
    ["en lektion","a lesson"],["en vikar","a substitute teacher"],["en rektor","a principal"],
  ],
  ...
  "Common Phrases & Idioms": [
    ...
    ["på grund af","because of"],["selvom","even though"],["i stedet for","instead of"],["i forhold til","in relation to"],
    ["fra tid til anden","from time to time"],["en gang imellem","once in a while"],["det kan man ikke vide","you never know"],["lad os se","let's see"],["det håber jeg","I hope so"],
    ["det tror jeg","I think so"],["stort set","basically"],["i det mindste","at least"],["hvis jeg var dig","if I were you"],
  ],
  "Prepositions & Connectors": [
    ...
    ["ud","out (direction)"],["hen","over / toward"],["forbi","past / by"],["omkring","around"],
  ],
  "Clothing & Shopping": [
    ...
    ["en mode","fashion"],["en stil","a style"],["et smykke","a piece of jewelry"],["en ring","a ring"],["en halskæde","a necklace"],
  ...
  "Technology & Media": [
    ...
    ["en hjemmeside","a website"],["en app","an app"],["et program","a program"],["et software","software"],["en fil","a file"],
    ...
    ["en streaming","streaming"],["en podcast","a podcast"],["nyheder","news"],["en blog","a blog"],["sociale medier","social media"],
    ...
    ["en sikkerhed","security"],["en backup","a backup"],["en server","a server"],["et netværk","a network"],["en router","a router"],
    ["et batteri","a battery"],["en opladning","charging"],["et skærmbillede","a screenshot"],["et hardware","hardware"],["en robot","a robot"],
...
function buildStarterAdditions(existingCategories, existingFrontsSet) {
  ...
  Object.entries(STARTER_WORDS).forEach(([catName, list]) => {
    list.forEach(([da, en]) => {
      ...
      seen.add(key);
      newCards.push({ type: "word", front: da, back: en, category: nameToId[catName.toLowerCase()], starter: true });
    });
  });
...
const WORD_INSIGHT_SYSTEM_PROMPT =
  "A Danish learner tapped a word or short phrase on their flashcard because they want to understand it more deeply. Explain it clearly and completely in plain English, in about 4-6 short flowing sentences (no headers, no bullet points): start with what kind of word it is and what it means; then include whichever of these genuinely applies — for a noun, its indefinite/definite singular and plural forms (e.g. en hund, hunden, hunde, hundene), noting plainly if it has no natural plural; for a verb, its principal forms (infinitive, present, past, past participle); for a preposition, adverb, or other small function word, 2-3 other common Danish words that share its root or pattern, and what that shared pattern actually means for the learner. Always finish your last sentence completely — never trail off or stop mid-thought.";
...
const LOCAL_MODEL_OPTIONS = [
  { id: "Qwen2.5-1.5B-Instruct-q4f16_1-MLC", label: "Qwen2.5 1.5B (better quality, ~1GB)" },
  { id: "Qwen2.5-0.5B-Instruct-q4f16_1-MLC", label: "Qwen2.5 0.5B (smaller & faster, ~500MB)" },
];
  ...
  if (!localEnginePromise) {
    ...
    localEnginePromise = (async () => {
      ...
      try {
        ...
        throw new Error("LOCAL_MODEL_LOAD_FAILED: " + (e && e.message ? e.message : e));
      }
      return engine;
    })().catch((e) => {
...
async function getAIEngine() {
  ...
  if (v === "local" || v === "api" || v === "gemini") return v;
...
function isSwitchableAIError(message) {
  return !!message && /AI settings|free tier limits|rejected the API key|doesn't support the local model|Couldn't load the local model/i.test(message);
}
...
export default function DanishFlashcards() {
  ...
  useEffect(() => {
    (async () => {
      ...
      // First-ever launch: preload the starter vocabulary automatically so
      // it's just there, rather than something you have to go find and tap.
      let alreadySeeded = null;
      try {
        alreadySeeded = await storeGet("starterVocabSeeded");
      } catch (e) {}
      if (c.length === 0 && !alreadySeeded) {
        const { newCards, combinedCategories } = buildStarterAdditions(cat, new Set());
        ...
        await storeSet("starterVocabSeeded", "true");
      }
  ...
  const addCards = useCallback(
    async (newCards) => {
      ...
      // skipped instead of producing a card with a missing word.
  ...
  return (
    <Shell>
      <Header cardCount={cards.length} onOpenSettings={() => setShowSettings(true)} />
      ...
      {showSettings && (
        <div
          ...
          style={{ position: "fixed", inset: 0, background: "rgba(35,39,42,0.55)", display: "flex", alignItems: "flex-end", zIndex: 60 }}
        >
          <div
            onClick={(e) => e.stopPropagation()}
            style={{ background: "var(--card)", borderRadius: "16px 16px 0 0", padding: 20, width: "100%", maxHeight: "82vh", overflowY: "auto" }}
          >
            <AISettingsPanel
...
function Header({ cardCount, onOpenSettings }) {
  return (
    <div style={{ padding: "22px 18px 14px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 4 }}>
        <button
          onClick={onOpenSettings}
          style={{ border: "none", background: "none", color: "var(--muted)", display: "flex", alignItems: "center", gap: 4, cursor: "pointer", fontFamily: "var(--sans)", fontSize: 11.5, padding: 0 }}
        >
          <Icon.Key size={12} />
          AI settings
        </button>
...
function StudyView({ cards, categories, updateCard, onOpenSettings, showToast, engine }) {
  ...
  useEffect(() => {
    const ids = cards
      .filter((c) => {
        if (!includeKnown && c.known) return false;
  ...
  }, [catFilter, starredOnly, includeKnown, sessionKey]);
  ...
  async function openInsight(card) {
    ...
    try {
      const reply = await callAI(
        ...
        'Danish word or phrase: "' + card.front + '"' + (card.back ? " (means: " + card.back + ")" : ""),
        { maxTokens: 700 }
      );
  ...
  async function submitAsk() {
    ...
    try {
      const reply = await callAI(
        "You're a Danish tutor answering one specific follow-up question a learner has about a single flashcard word or phrase they're studying. Answer directly and concisely in plain English, focused only on what they actually asked.",
  ...
  const sessionCards = poolIds.map((id) => cards.find((c) => c.id === id)).filter(Boolean);
  const knownNowCount = sessionCards.filter((c) => c.known).length;
  const stillUnknownCount = sessionCards.length - knownNowCount;
  const starredInSessionCount = sessionCards.filter((c) => c.starred).length;
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 10, flexWrap: "wrap" }}>
        <Pill color="var(--rust)" active={starredOnly} onClick={() => setStarredOnly(!starredOnly)}>
          ★ Starred only
        </Pill>
        <Pill color="#4C8A5E" active={includeKnown} onClick={() => setIncludeKnown(!includeKnown)}>
          ✓ Include known
        </Pill>
      </div>
        ...
        >
          ...
          >
            ...
            {insightLoading ? (
              ...
              <div style={{ fontFamily: "var(--sans)", fontSize: 14, lineHeight: 1.65, whiteSpace: "pre-wrap" }}>
                {insightCache[insightFor]}
              </div>
            )}
          </div>
        </div>
      ...
      {askFor && (
        <div
          ...
          style={{ position: "fixed", inset: 0, background: "rgba(35,39,42,0.55)", display: "flex", alignItems: "flex-end", zIndex: 50 }}
        >
          <div
            onClick={(e) => e.stopPropagation()}
            style={{ background: "var(--card)", borderRadius: "16px 16px 0 0", padding: 20, width: "100%", minHeight: "58vh", maxHeight: "80vh", overflowY: "auto" }}
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
              <div style={{ fontFamily: "var(--serif)", fontSize: 18, color: "var(--terracotta)" }}>
            ...
            {askAnswer && (
              <div style={{ fontFamily: "var(--sans)", fontSize: 14, lineHeight: 1.65, whiteSpace: "pre-wrap" }}>{askAnswer}</div>
            )}
          </div>
        </div>
      )}
...
function StarterVocabButton({ cards, categories, persistCategories, addCards }) {
  const existingFronts = useMemo(() => new Set(cards.map((c) => c.front.trim().toLowerCase())), [cards]);

  const remaining = useMemo(() => {
    let count = 0;
    Object.values(STARTER_WORDS).forEach((list) =>
      list.forEach(([da]) => {
        if (!existingFronts.has(da.trim().toLowerCase())) count++;
      })
    );
    return count;
  }, [existingFronts]);
  ...
  function load() {
    const { newCards, combinedCategories } = buildStarterAdditions(categories, existingFronts);
    if (combinedCategories.length !== categories.length) persistCategories(combinedCategories);
  ...
  return (
    ...
    >
      ...
      Add starter vocabulary ({remaining} word{remaining === 1 ? "" : "s"})
    </button>
  );
}
...
function LibraryView({ cards, categories, updateCard, deleteCard, persistCategories, addCards, onOpenSettings }) {
  ...
  // with (e.g. "en hund") — strip them for sorting purposes so words
  // alphabetize by their actual first letter, not "e" for everything.
  const sortKey = (word) => word.replace(/^(en|et)\s+/i, "");
  ...
  return (
    <div>
      ...
      <StarterVocabButton cards={cards} categories={categories} persistCategories={persistCategories} addCards={addCards} />

      <div style={{ display: "flex", gap: 6, marginBottom: 8, flexWrap: "wrap" }}>
        {["all", "word", "sentence", "grammar"].map((t) => (
          <Pill key={t} color="var(--rust)" active={typeFilter === t} onClick={() => setTypeFilter(t)}>
        ...
        <Pill
          color="#4C8A5E"
          active={knownFilter === "known"}
          onClick={() => setKnownFilter(knownFilter === "known" ? "all" : "known")}
        >
          ✓ Known ({knownCount})
        </Pill>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8, flexWrap: "wrap" }}>
        <span style={{ fontFamily: "var(--sans)", fontSize: 12, color: "var(--muted)" }}>Show:</span>
        {[
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 12, flexWrap: "wrap" }}>
        <span style={{ fontFamily: "var(--sans)", fontSize: 12, color: "var(--muted)" }}>Sort:</span>
        <Pill color="var(--rust)" active={sortDir === "asc"} onClick={() => setSortDir("asc")}>
          A–Z
        </Pill>
        <Pill color="var(--rust)" active={sortDir === "desc"} onClick={() => setSortDir("desc")}>
          Z–A
        </Pill>
      </div>
        ...
        >
          ...
          >
            ...
            {insightLoading ? (
              ...
              <div style={{ fontFamily: "var(--sans)", fontSize: 14, lineHeight: 1.65, whiteSpace: "pre-wrap" }}>{insightCache[insightFor]}</div>
            )}
          </div>
        </div>
      )}
...
function AddCardView({ categories, addCategory, addCards, onOpenSettings }) {
  ...
  async function autoFill(direction, value) {
    ...
    try {
      ...
      if (parsed.translation) {
        if (direction === "da") setBack((prev) => (prev.trim() ? prev : parsed.translation));
        else setFront((prev) => (prev.trim() ? prev : parsed.translation));
      }
  ...
  async function lookupGrammar() {
    ...
    try {
      const reply = await callAI(
        "You are a Danish tutor. Given a grammar point name or short description from an intermediate, self-taught learner, explain it concisely in plain English (2-4 sentences, no jargon overload) and give up to 3 example sentences (Danish and English) illustrating it.",
        'Grammar point: "' +
          front.trim() +
          '"\n\nRespond ONLY with JSON, no other text: {"explanation": "...", "examples": [{"da": "...", "en": "..."}]}',
        { maxTokens: 900 }
      );
      const parsed = parseJSONLoose(reply);
      setBack(parsed.explanation || "");
      if (parsed.examples && parsed.examples.length) {
        setExamples(parsed.examples.map((ex) => ({ da: ex.da || "", en: ex.en || "" })));
      }
    } catch (e) {
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 12 }}>
        {["word", "sentence", "grammar"].map((t) => (
          <Pill key={t} color={TYPE_COLOR[t]} active={type === t} onClick={() => setType(t)}>
            {TYPE_LABEL[t]}
          </Pill>
        ))}
      </div>
      ...
      {type === "grammar" && (
        <div style={{ marginTop: -6, marginBottom: 14 }}>
          ...
          >
            {lookingUp ? <Icon.Loader2 size={12} className="spin" /> : <Icon.Wand2 size={12} />}
      ...
      <Field label="Category">
        ...
        />
        {autoFilling && (
          <div style={{ display: "flex", alignItems: "center", gap: 5, marginTop: 6, color: "var(--muted)", fontFamily: "var(--sans)", fontSize: 12 }}>
            <Icon.Loader2 size={11} className="spin" /> Auto-filling…
          </div>
        )}
      </Field>

      <button onClick={submit} style={{ ...smallBtn("var(--rust)"), width: "100%", padding: "11px", fontSize: 14, marginTop: 4 }}>
        Add card
      </button>
    </div>
  );
...
function AISettingsPanel({ onClose }) {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (e === "local" || e === "api") setShowMore(true);
    })();
  }, []);
  ...
  const geminiActive = engine === "gemini";
  ...
  return (
    <div style={{ background: "var(--card)", border: "1px solid var(--line)", borderRadius: 12, padding: 16, marginBottom: 14 }}>
      ...
      <div
        style={{
          border: "1.5px solid " + (geminiActive ? "var(--fjord)" : "var(--line)"),
          borderRadius: 10,
          padding: 14,
          background: geminiActive ? "#EEF2F0" : "transparent",
        }}
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
          <div style={{ fontFamily: "var(--sans)", fontSize: 13.5, fontWeight: 600 }}>Google Gemini</div>
          <span style={{ fontFamily: "var(--sans)", fontSize: 10.5, fontWeight: 700, color: "var(--fjord)", letterSpacing: 0.3 }}>
            FREE · RECOMMENDED
          </span>
        </div>
        <div style={{ fontFamily: "var(--sans)", fontSize: 12.5, color: "var(--muted)", lineHeight: 1.5, marginBottom: 12 }}>
          No credit card. Also handles Photo import, since it can read images. Good quality for everyday use, a step
          behind Claude on tricky grammar.
        </div>

        {savedGeminiKey ? (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
            <span style={{ fontFamily: "var(--sans)", fontSize: 12.5, color: "var(--fjord)", fontWeight: 600 }}>
              {geminiActive ? "Connected" : "Key saved"}
            </span>
            <div style={{ display: "flex", gap: 8 }}>
              {!geminiActive && (
      ...
      {showMore && (
        <>
          <div style={{ border: "1.5px solid " + (engine === "local" ? "var(--fjord)" : "var(--line)"), borderRadius: 10, padding: 14, marginTop: 12 }}>
            ...
            <div style={{ fontFamily: "var(--sans)", fontSize: 12.5, color: "var(--muted)", lineHeight: 1.5, marginBottom: 10 }}>
              Runs in this browser tab — free, no key, works offline after a one-time download. Needs WebGPU
              (recent Chrome, Edge, or Safari). Weaker than Gemini at Danish, and heavier on a phone's battery and
              storage. Can't do Photo import.
            </div>
          ...
          <div style={{ border: "1.5px solid " + (engine === "api" ? "var(--fjord)" : "var(--line)"), borderRadius: 10, padding: 14, marginTop: 10 }}>
            <div style={{ fontFamily: "var(--sans)", fontSize: 13.5, fontWeight: 600, marginBottom: 6 }}>My Anthropic key</div>
            <div style={{ fontFamily: "var(--sans)", fontSize: 12.5, color: "var(--muted)", lineHeight: 1.5, marginBottom: 10 }}>
              Best quality, small per-use cost. From console.anthropic.com.
            </div>
            {savedKey ? (
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                <span style={{ fontFamily: "var(--sans)", fontSize: 12.5, color: "var(--fjord)", fontWeight: 600 }}>
                  {engine === "api" ? "Connected" : "Key saved"}
                </span>
                <div style={{ display: "flex", gap: 8 }}>
                  {engine !== "api" && (
...
function ChatView({ categories, addCategory, addCards, showToast, engine, onOpenSettings }) {
  ...
  const quickActions = [
    { id: "chat", label: "Chat", icon: Icon.MessageCircle },
    { id: "sentence", label: "Sentence", icon: Icon.Wand2 },
    ...
    <div>
      ...
      {engine && (
        <>
          ...
          {mode === "sentence" && <SentencePanel engine={engine} categories={categories} addCategory={addCategory} addCards={addCards} onOpenSettings={onOpenSettings} />}
          {mode === "article" && <TextExtractPanel engine={engine} categories={categories} addCategory={addCategory} addCards={addCards} onOpenSettings={onOpenSettings} />}
          {mode === "photo" && <PhotoPanel categories={categories} addCategory={addCategory} addCards={addCards} onOpenSettings={onOpenSettings} />}
        </>
      )}
    </div>
  );
...
function ChatConversation({ engine, categories, addCategory, addCards, showToast, onOpenSettings }) {
  ...
  async function send() {
    ...
    try {
      ...
      const reply = await callAI(
        "You are a friendly, knowledgeable Danish language tutor. The learner is intermediate but self-taught, so they have some foundational gaps in grammar despite a decent vocabulary. Answer clearly and concisely in plain English. Use Danish examples with English translations whenever they help. Don't over-explain simple things, but don't assume advanced grammar terms are familiar either.",
        text,
        { maxTokens: 800, history: history.slice(0, -1) }
      );
    ...
    try {
      ...
      const reply = await callAI(
        "You turn a Danish-tutor question and answer into the single most useful flashcard for the learner to review later. Choose whichever type genuinely fits best: " +
          "'word' if this was really just about one word or a short bit of vocabulary (front = the Danish word, back = the English meaning); " +
          ...
          "For 'word' or 'sentence' types, also pick the single best-fitting category (e.g. by part of speech or topic) — prefer an existing category if one genuinely fits, otherwise suggest a short new one. " +
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 360px)", minHeight: 300 }}>
      ...
      <div ref={scrollRef} style={{ flex: 1, overflowY: "auto", marginBottom: 10 }}>
        {ready && messages.length === 0 && (
          <EmptyState
            ...
            body='e.g. "how do I say if I could, then I would?" — you can save the answer as a grammar flashcard'
          />
        )}
        {messages.map((m, i) => (
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <input
          ...
          placeholder="Ask a question about Danish…"
          style={{ ...inputStyle, flex: 1 }}
        />
        <button
          onClick={send}
...
function SentencePanel({ engine, categories, addCategory, addCards, onOpenSettings }) {
  const [input, setInput] = useState("");
  ...
  async function analyze() {
    ...
    try {
      const text = await callAI(
        "You are a patient Danish tutor for an intermediate, self-taught learner who has foundational grammar gaps. The user will give you a sentence, in English or Danish, that they're trying to figure out how to say or understand correctly. " +
          "Identify the key grammar structure involved, explain it in plain, concise English (2-4 sentences, no jargon overload), give the correct Danish version of their sentence, and provide exactly 4 more example sentences that use the same grammar structure in different contexts. Also suggest one short category name for this grammar point. " +
          'Respond ONLY with JSON in this exact shape, no other text: {"grammarName": "...", "explanation": "...", "mainExample": {"da": "...", "en": "..."}, "examples": [{"da":"...","en":"..."}, {"da":"...","en":"..."}, {"da":"...","en":"..."}, {"da":"...","en":"..."}], "suggestedCategory": "..."}',
        input.trim(),
        { maxTokens: 1500 }
      );
      const parsed = parseJSONLoose(text);
      setResult(parsed);
      setSelected({ grammar: true, main: true, 0: true, 1: true, 2: true, 3: true });
      const existing = categories.find((c) => c.name.toLowerCase() === (parsed.suggestedCategory || "").toLowerCase());
      setCategory(existing ? existing.id : "__new__" + (parsed.suggestedCategory || ""));
    } catch (e) {
      setError(apiErrorMessage(e));
    } finally {
      setLoading(false);
  ...
  function addSelected() {
    if (!result) return;
    let catId = category;
    if (category.startsWith("__new__")) catId = addCategory(category.replace("__new__", "") || "New grammar point");
    const toAdd = [];
    if (selected.grammar) {
      toAdd.push({
        type: "grammar",
        front: result.grammarName,
        back: result.explanation,
        notes: "Example: " + result.mainExample.da + " — " + result.mainExample.en,
        category: catId,
        examples: result.examples,
      });
    }
    if (selected.main) toAdd.push({ type: "sentence", front: result.mainExample.da, back: result.mainExample.en, category: catId });
    result.examples.forEach((ex, i) => {
      if (selected[i]) toAdd.push({ type: "sentence", front: ex.da, back: ex.en, category: catId });
    });
  ...
  return (
    <div>
      <div style={{ fontFamily: "var(--sans)", fontSize: 13, color: "var(--muted)", marginBottom: 12, lineHeight: 1.5 }}>
        Type a sentence you're trying to say or understand — in English or Danish — and get the grammar rule behind it plus more examples.
      </div>
      <textarea value={input} onChange={(e) => setInput(e.target.value)} placeholder='e.g. "if I could, I would" or "hvis jeg kunne, ville jeg"' style={{ ...inputStyle, minHeight: 70 }} />
      <button
        onClick={analyze}
        disabled={loading}
        style={{ ...smallBtn("var(--fjord)"), width: "100%", padding: "11px", fontSize: 14, marginTop: 10, display: "flex", justifyContent: "center", alignItems: "center", gap: 7 }}
      >
        {loading ? <Icon.Loader2 size={15} className="spin" /> : <Icon.Wand2 size={15} />}
        {loading ? loadingCopy(engine) : "Analyze sentence"}
      </button>

      <AIErrorNote message={error} onOpenSettings={onOpenSettings} />

      {result && (
        <div style={{ marginTop: 18, background: "var(--card)", border: "1px solid var(--line)", borderRadius: 12, padding: 14 }}>
          <div style={{ fontFamily: "var(--serif)", fontSize: 17, marginBottom: 6 }}>{result.grammarName}</div>
          <div style={{ fontFamily: "var(--sans)", fontSize: 13.5, lineHeight: 1.5, marginBottom: 10 }}>{result.explanation}</div>

          <label style={rowCheck}>
            <input type="checkbox" checked={!!selected.grammar} onChange={(e) => setSelected({ ...selected, grammar: e.target.checked })} />
          ...
          <div style={{ borderTop: "1px solid var(--line)", margin: "10px 0", paddingTop: 10 }}>
            <label style={rowCheck}>
              <input type="checkbox" checked={!!selected.main} onChange={(e) => setSelected({ ...selected, main: e.target.checked })} />
              <span style={{ fontFamily: "var(--sans)", fontSize: 13.5 }}>
                <b style={{ color: "var(--terracotta)" }}>{result.mainExample.da}</b> —{" "}
                <span style={{ color: "var(--sage)" }}>{result.mainExample.en}</span>
              </span>
            </label>
            {result.examples.map((ex, i) => (
              <label key={i} style={rowCheck}>
          ...
          <Field label="Category">
            <CategoryPicker
              categories={categories}
              value={category.startsWith("__new__") ? "" : category}
              onChange={setCategory}
              allowNew
              onAddCategory={(name) => addCategory(name)}
            />
            {category.startsWith("__new__") && (
              <div style={{ fontFamily: "var(--sans)", fontSize: 12, color: "var(--fjord)", marginTop: 4 }}>
                Will create new category: {category.replace("__new__", "")}
              </div>
            )}
          </Field>

          <button onClick={addSelected} style={{ ...smallBtn("var(--rust)"), width: "100%", padding: "10px", fontSize: 14, marginTop: 4 }}>
...
function TextExtractPanel({ engine, categories, addCategory, addCards, onOpenSettings }) {
  ...
  async function lookup() {
    ...
    try {
      const reply = await callAI(
        "You translate single Danish or English words or short phrases for a language learner. Auto-detect which language the input is in and give the natural translation in the other language. If it's a Danish noun, include its grammatical article (en/et) with the Danish form, and match it with a natural English article ('a'/'an') only when the noun is countable that way in English — omit the article on both sides for mass/uncountable nouns (e.g. anger, water). Never show an article on only one side.",
        'Translate this: "' + lookupInput.trim() + '". Respond ONLY with JSON, no other text: {"da": "...", "en": "..."}',
        { maxTokens: 300 }
      );
      const parsed = parseJSONLoose(reply);
  ...
  return (
    <div>
      <div style={{ fontFamily: "var(--sans)", fontSize: 13, color: "var(--muted)", marginBottom: 10, lineHeight: 1.5 }}>
        Type a Danish or English word or short phrase to translate it instantly.
      </div>
      <div style={{ display: "flex", gap: 8 }}>
        <input
          value={lookupInput}
          ...
          placeholder='e.g. "hyggelig" or "cozy"'
          style={{ ...inputStyle, flex: 1 }}
        />
        <button onClick={lookup} disabled={lookupLoading || !lookupInput.trim()} style={smallBtn("var(--fjord)")}>
          {lookupLoading ? <Icon.Loader2 size={14} className="spin" /> : "Translate"}
        </button>
      </div>
      ...
      {lookupResult && (
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 12, background: "var(--card)", border: "1px solid var(--line)", borderRadius: 10, padding: "10px 12px" }}>
          <div style={{ flex: 1, fontFamily: "var(--sans)", fontSize: 14, minWidth: 0 }}>
            <span style={{ color: "var(--terracotta)" }}>{lookupResult.da}</span> — <span style={{ color: "var(--sage)" }}>{lookupResult.en}</span>
          </div>
          <select
      ...
      <div style={{ fontFamily: "var(--sans)", fontSize: 13, color: "var(--muted)", marginBottom: 12, lineHeight: 1.5 }}>
        Or paste a longer article or text — I'll explain the grammar at work in it and suggest key vocabulary with
        translations you can confirm.
      </div>
      <textarea value={text} onChange={(e) => setText(e.target.value)} placeholder="Paste Danish text here…" style={{ ...inputStyle, minHeight: 120 }} />
      <button
        onClick={analyzeText}
        disabled={!text.trim() || analyzing}
        style={{ ...smallBtn("var(--fjord)"), width: "100%", padding: "11px", fontSize: 14, marginTop: 10, display: "flex", justifyContent: "center", alignItems: "center", gap: 7, opacity: text.trim() ? 1 : 0.5 }}
      >
        {analyzing ? <Icon.Loader2 size={14} className="spin" /> : <Icon.Wand2 size={14} />}
        {analyzing ? loadingCopy(engine) : "Analyze text"}
      </button>

      <AIErrorNote message={error} onOpenSettings={onOpenSettings} />

      {analysis && (
        <div style={{ marginTop: 16, background: "var(--card)", border: "1px solid var(--line)", borderRadius: 12, padding: 14 }}>
          <div style={{ fontFamily: "var(--sans)", fontSize: 13.5, lineHeight: 1.5, marginBottom: 14 }}>{analysis.grammarNotes}</div>
            ...
            {(analysis.vocabulary || []).map((v, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                <label style={{ display: "flex", alignItems: "center", gap: 8, flex: 1, minWidth: 0 }}>
                  <input type="checkbox" checked={!!selected[v.da]} onChange={(e) => setSelected({ ...selected, [v.da]: e.target.checked })} />
...
function PhotoPanel({ categories, addCategory, addCards, onOpenSettings }) {
  ...
  async function extract() {
    ...
    try {
      ...
      const system =
        ...
        "Existing categories to prefer if one fits: " +
        (categoryNames || "(none yet)");
      const userText = "Extract Danish vocabulary and sentences from this image.";
      const text =
        backend === "gemini"
          ? await callGeminiImage(system, userText, base64, mediaType)
          : await callClaudeImage(system, userText, base64, mediaType);
      const parsed = parseJSONLoose(text);
  ...
  return (
    <div>
      <div style={{ fontFamily: "var(--sans)", fontSize: 13, color: "var(--muted)", marginBottom: 12, lineHeight: 1.5 }}>
        Upload a screenshot of Danish text — a book, an app, a sign — and pull out words or sentences to add to your deck.
      </div>
      ...
      >
        ...
        />
        {preview ? (
          <img src={preview} alt="Selected screenshot" style={{ maxWidth: "100%", maxHeight: 220, borderRadius: 6 }} />
        ) : (
          <>
      ...
      {file && (
        <button
          ...
          style={{ ...smallBtn("var(--fjord)"), width: "100%", padding: "11px", fontSize: 14, marginTop: 10, display: "flex", justifyContent: "center", alignItems: "center", gap: 7 }}
        >
          {loading ? <Icon.Loader2 size={15} className="spin" /> : <Icon.Camera size={15} />}
          {loading ? "Reading image…" : "Extract words"}
        </button>
      )}
          ...
          {items.map((it, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
              <label style={{ display: "flex", alignItems: "center", gap: 8, flex: 1, minWidth: 0 }}>
                <input type="checkbox" checked={!!selected[i]} onChange={(e) => setSelected({ ...selected, [i]: e.target.checked })} />
                <span style={{ fontFamily: "var(--sans)", fontSize: 13.5, minWidth: 0 }}>
                  <span style={{ color: "var(--terracotta)" }}>{it.danish}</span> —{" "}
                  <span style={{ color: "var(--sage)", fontStyle: "italic" }}>{it.english}</span>
                </span>
              </label>
              <select
